...
model.load_state_dict(load_state_dict('./experiment/exp_05-09_22:16:27/controlnet/version_0/checkpoints/epoch=37-step=99999.ckpt', location='cuda'))
model = model.cuda()
...
input_image = cv2.imread('data/deepfashion/deepfashion_train/000000/pants_segm.png', -1)
prompt = "a blue jean pants" # "best quality, extremely detailed"
a_prompt = ""
n_prompt = ""
...
with torch.no_grad():
    ...
    cv2.imwrite('output.png', x_samples[0][:,:,::-1])